...
switch startPointScript
    case 'No'
        %Do nothing, choosed this way round because I want to reiniatlize
        %variables if answer is 'Yes' or empty ''. But switch/case
        %arguments do not take into account "case 'Yes' || case ''" it
        %seems.
