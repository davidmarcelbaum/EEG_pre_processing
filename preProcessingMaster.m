...
if Filenum == numel(FilesList) && Filenum ~= 0
    switch scriptPart
        case 1 %In case "RAWing, Filtering and/or re-referencing" selected %%%%
            msgbox({'Operation Completed', datetime(now,'ConvertFrom','datenum'),...
                ' ',...
        ...
        case 6 %In case "Compute dipoles ..." selected
            msgbox({'Operation Completed', datetime(now,'ConvertFrom','datenum'),...
                ' ',...
                'Script processed dipoles for ' string(cyclesRunDipfit) ' of ' string(numel(FilesList)) ' datasets',...
                'and asigned dipoles to brain areas for ' string(cyclesRunAtlas) ' of ' string(numel(FilesList)) ' datasets',...
                ' ',...
                'Datasets have been saved in',...
                folderDipoles,...
                folderAtlas});
