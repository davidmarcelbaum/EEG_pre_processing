...
if Filenum == numel(FilesList) && Filenum ~= 0
    switch scriptPart
        ...
        case 6 %In case "Compute dipoles ..." selected
            msgbox({'Operation Completed', datetime(now,'ConvertFrom','datenum'),...
                ' ',...
                'Script processed dipoles for ' string(cyclesRun) ' of ' string(numel(FilesList)) ' datasets',...
                'and asigned dipoles to brain areas for ' string(cyclesRun) ' of ' string(numel(FilesList)) ' datasets',...
                ' ',...
                'Datasets have been saved in',...
                folderDipoles});
        case 7 %In case "Organize Triggers" selected
